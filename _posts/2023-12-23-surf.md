...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <video autoplay controls width="770" height="433" src="https://live-sec.streamworks.video/oceaneye/oceaneye30.stream/playlist.m3u8" type="application/vnd.apple.mpegurl" class="media-document mac video"></video>
    </div>
</div>
