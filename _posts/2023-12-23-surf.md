...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include video.html width="100%" height="auto" path="https://live-sec.streamworks.co.za/oceaneye/oceaneye45.stream/playlist_dvr.m3u8" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
